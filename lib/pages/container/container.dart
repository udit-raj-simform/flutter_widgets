    ...
    return CustomScaffold(
      ...
      body: Center(
        ...
        children: [
          ...
          Container(
              height: MyConstants.height / 3.5,
              width: MyConstants.width / 3.2,
              clipBehavior: Clip.antiAlias,
              decoration: const BoxDecoration(
              ...
              child: Stack(
                ...
                children: <Widget>[
                  Positioned(
                      bottom: MyConstants.height / 8,
                      right: MyConstants.width / 12,
                      child: Container(
                        width: MyConstants.width / 3.5,
                        height: MyConstants.height / 3.5,
                        decoration: const BoxDecoration(
          ...
          Container(
              ...
              child: FractionalTranslation(
                  ...
                  child: Container(
                    width: MyConstants.width / 2.5,
                    height: MyConstants.height / 2.5,
                    decoration: const BoxDecoration(
                      color: Colors.white38,
                      shape: BoxShape.circle,
                    ),
